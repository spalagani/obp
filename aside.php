      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo $serverurl ?>view.php"><i class="fa fa-check"></i> View Users</a></li>
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li ><a href="<?php echo $serverurl ?>view.php?list=payments"><i class="fa fa-search"></i> Search Users</a></li>
